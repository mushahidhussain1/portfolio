...
<center>
<img src="(https://mushahidhussain.vercel.app/images/profile.png)" alt="Mushahid Hussain" />
</center>

Live demo here: <a href="/portfolio.png" target="_blank">https://mushahidhussain.vercel.app/</a>
    ...
    const SEO = [
    	{
    		page: "home",
    		description:
    			"I am a backend developer with expertise in PHP and Laravel. I have experience in building scalable, secure and reliable web applications using various frameworks and technologies.",
    		keywords: ["Mushahid", "Mushahid H", "Mushahid Hussain"],
    	},
    ];
    ```
